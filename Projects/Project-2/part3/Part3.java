 ...
 */
public class Part3 implements PlayerModulePart1, PlayerModulePart2, PlayerModulePart3 {
    ...
    public PlayerMove move() {
        ...
        PlayerMove move = legal_moves.get(0);
        Coordinate move_coordinate = move.getCoordinate();
        return new PlayerMove(move_coordinate, this.playerID);
    }
